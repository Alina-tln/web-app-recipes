...
def handle_not_found(func):
    ...
    async def wrapper(*args, **kwargs):
        try:
            ...
            raise HTTPException(status_code=404, detail=f"Ingredients not found: {e}")
    return wrapper
...
@handle_not_found
async def update_recipe(recipe_id: int, updated: RecipeUpdateSchema, service: RecipeServiceDep):
